...
Apriltag::World::WorldInfo FIELD {
    ...
    .tags = Apriltag::World::AllTagsInfo {
        ...
        // window wall fixed tags
        Apriltag::World::TagLocation {.id = 4, .x = 0, .y = 211, .z = 111.5, .yaw = 0},
        Apriltag::World::TagLocation {.id = 5, .x = 0, .y = 317.5, .z = 88, .yaw = 0},
        
        // door side wall fixed tags 
        Apriltag::World::TagLocation {.id = 6, .x = 185, .y = 0, .z = 115, .yaw = 90},
        Apriltag::World::TagLocation {.id = 3, .x = 318, .y = 0, .z = 115, .yaw = 90},
